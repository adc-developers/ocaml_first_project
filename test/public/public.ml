...
let public_query2 _ =
  ...
  assert_equal true (List.mem person2 applied) ~msg:"condition_if applied to db2 does not contain person2";
  assert_equal false (List.mem person3 applied) ~msg:"condition_if applied to db2 contains person3";
